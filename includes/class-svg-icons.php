 ...
 * SVG Icons Library
 *
 * Professional SVG icons for AI Site Builder Pro
 * All icons are inline SVG for best performance
 *
...
class SVG_Icons {
    ...
    public static function render( $name, $size = 24, $class = '' ) {
        echo self::get( $name, $size, $class );
    }

    /**
     * Get all icons
     *
     * @return array Icon definitions.
     */
    private static function get_icons() {
        return array(
            ...
            'bullhorn' => '<path d="m3 11 18-5v12L3 14v-3z"/><path d="M11.6 16.8 a3 3 0 1 1-5.8-0.8"/>',
